...
$ENV{"PROJECT_CACHE_DIR"} = "$ENV{\"PROJECT_ROOT\"}/.cache/latex";
...
set_tex_cmds("--shell-escape --synctex=1 -file-line-error -8bit -interaction=nonstopmode -halt-on-error -recorder, %O %S");
...
# Run the TeX quality check and spell check commands after successful compilation.
